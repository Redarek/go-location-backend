...
func (s *matrixService) SearchPoints(ctx context.Context, filter entity.SearchParameters) (points []*entity.Point, err error) {
	points, err = s.repository.SearchPoints(ctx, filter)
	return
}
